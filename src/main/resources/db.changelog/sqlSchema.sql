...
(
    id          int8 default nextval('hibernate_sequence'::regclass) not null primary key unique,
    date        date                                          not null,
    employee_id      int8                                          not null constraint fk_foreign_key_ay_off_employee references employee
);
...
(
    ...
    employee_id      int8                                          not null constraint fk_foreign_key_vacation_employee references employee
);
...
(
    ...
    employee_id      int8                                          not null constraint fk_foreign_key_salary_employee references employee
);
...
(
    ...
    employee_id      int8                                      not null constraint fk_foreign_key_user_employee references employee
);
